...
4. **O log truncado desaparece no Pi?** (§5.1)
5. **O teto de 20 min/dia do BikeControl vale para o modo OBC?** (§5.2)
6. **O defeito do keep-alive chega a se manifestar?** (§4.1) Só investigar se aparecer.
